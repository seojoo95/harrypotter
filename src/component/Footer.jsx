    ...
    <FooterWrap>
      <div className="footerContent">
        <div className="leftContents">
          <h1 className="logo">
            <img
              src={process.env.PUBLIC_URL + "/img/ww-logo.svg"}
              alt="wizard logo"
            />
          </h1>
          <ul className="snsList">
            <li>
              <a href="https://x.com/harrypottershop" target="_blank">
                <FaXTwitter />
              </a>
            </li>
            <li>
              <a
                href="https://www.instagram.com/harrypottershop/#"
                target="_blank"
              >
                <FaInstagram />
              </a>
            ...
            <li>
              <a
                href="https://www.facebook.com/harrypottershop"
                target="_blank"
              >
                <FaFacebook />
              </a>
            ...
            <li>
              <a href="https://www.tiktok.com/@harrypottershop" target="_blank">
                <FaTiktok />
              </a>
            </li>
          </ul>
